...
# 1.01.00   2007-08-08  Bir     First version
...
LIBRARIES_TO_BUILD      += Can_30_Mcan
Can_30_Mcan_FILES               = Can_30_Mcan$(BSW_SRC_DIR)\Can_30_Mcan.c

# e.g.: CC_FILES_TO_BUILD       += drv\can_drv.c
CC_FILES_TO_BUILD       += Can_30_Mcan$(BSW_SRC_DIR)\Can_30_Mcan.c Can_30_Mcan$(BSW_SRC_DIR)\Can_30_Mcan_Irq.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\Can_30_Mcan_PBcfg.c $(GENDATA_DIR)\Can_30_Mcan_Lcfg.c
