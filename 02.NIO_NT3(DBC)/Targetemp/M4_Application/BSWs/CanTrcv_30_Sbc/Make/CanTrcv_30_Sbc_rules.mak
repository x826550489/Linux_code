############################################################################### 
# File Name  : CanTrcv_30_Sbc_rules.mak 
...
# 1.07.00   2014-08-15  Rse     Adapted to Sbc Transceiver driver
# 1.08.00   2019-02-06  vircbl  Added support of component-based SIP structure
#------------------------------------------------------------------------------
...
LIBRARIES_TO_BUILD      += CanTrcv_30_Sbc
CanTrcv_30_Sbc_FILES    = CanTrcv_30_Sbc$(BSW_SRC_DIR)\CanTrcv_30_Sbc.c

# e.g.: CC_FILES_TO_BUILD += drv\CanTrcv_30_Sbc.c
CC_FILES_TO_BUILD       += CanTrcv_30_Sbc$(BSW_SRC_DIR)\CanTrcv_30_Sbc.c
CPP_FILES_TO_BUILD      +=
ASM_FILES_TO_BUILD      +=
...
GENERATED_SOURCE_FILES  += $(GENDATA_DIR)\CanTrcv_30_Sbc_Cfg.c
