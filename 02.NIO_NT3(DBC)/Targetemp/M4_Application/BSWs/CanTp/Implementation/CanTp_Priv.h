...
#define CanTp_RxCfg_GetSduMetadataLength(Index)        ((uint8)(CanTp_GetSduMetadataLengthOfRxSduCfg((Index))))  /* returns: SduMetadataLength */
#define CanTp_RxCfg_GetPduMetadataLength(Index)        ((uint8)(CanTp_GetPduMetadataLengthOfRxSduCfg((Index))))  /* returns: PduMetadataLength */

#if (CANTP_RX_HAS_CUSTOM_ADDRESSING == STD_ON)
# define CanTp_RxCfg_GetCustomAddressingCallout(Index)  CanTp_GetUpLayerFctsRx(CanTp_GetUpLayerFctsRxIdxOfRxSduCfg((Index)))
#endif
#if (CANTP_TX_HAS_CUSTOM_ADDRESSING == STD_ON)
# define CanTp_TxCfg_GetCustomAddressingCallout(Index) CanTp_GetUpLayerFctsTx(CanTp_GetUpLayerFctsTxIdxOfTxSduCfg((Index)))
#endif
...
#define CanTp_TxCfg_GetPduMetadataLength(Index)        ((uint8)(CanTp_GetPduMetadataLengthOfTxSduCfg((Index))))  /* returns: PduMetadataLength */
...
#define CanTp_RxCfg_GetMaxPayloadSF(RxHdl)      ((uint8)(CANTP_CAN20_FRAME_LENGTH - (CanTp_Util_GetAdrOffset(CanTp_RxCfg_GetAddressingFormat((RxHdl))) + CANTP_PCI_LENGTH_SF)))
...
#define CanTp_TxCfg_GetMaxPayloadSF(TxHdl)      ((uint8)(CANTP_CAN20_FRAME_LENGTH - (CanTp_Util_GetAdrOffset(CanTp_TxCfg_GetAddressingFormat((TxHdl))) + CANTP_PCI_LENGTH_SF)))
...
# define CanTp_RxCfg_GetMaxSFDataLength(RxHdl, DLC)   (((DLC) >  (PduLengthType)CANTP_CAN20_FRAME_LENGTH) ? ((DLC) - (CanTp_Util_GetAdrOffset(CanTp_RxCfg_GetAddressingFormat((RxHdl))) + (PduLengthType)CANTP_PCI_LENGTH_LSF)) : (CanTp_RxCfg_GetMaxPayloadSF((RxHdl))))
#else
...
# define CanTp_RxPduHasTxSduRef(CanTpRxPduId)     CanTp_IsTxSduCfgIndUsedOfRxPduMap((CanTpRxPduId))                    /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#else
# define CanTp_RxPduHasTxSduRef(CanTpRxPduId)     FALSE
#endif
#if (CANTP_RX_OPTIMIZATION != CANTP_OPT_ZERO_SDU)                                                                      /* COV_CANTP_ROBUSTNESS_CASE TX */
# define CanTp_RxPduHasRxSduRef(CanTpRxPduId)     CanTp_IsRxSduCfgIndUsedOfRxPduMap((CanTpRxPduId))                    /* PRQA S 3453 */ /* MD_MSR_FctLikeMacro */
#else
# define CanTp_RxPduHasRxSduRef(CanTpRxPduId)     FALSE
#endif
