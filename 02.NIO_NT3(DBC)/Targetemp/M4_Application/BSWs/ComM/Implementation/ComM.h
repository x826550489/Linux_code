...
# define CCL_ASR4COMMCFG5_VERSION                (0x1500u)
 ...
 *  \trace       CREQ-292564
*********************************************************************************************************************/
extern FUNC(Std_ReturnType, COMM_CODE) ComM_GetCurrentPNCComMode(ComM_UserHandleType User, P2VAR(ComM_ModeType, AUTOMATIC, COMM_APPL_VAR) ComMode);
 ...
 *  \details     -
 *  \param[in]   Channel                 Valid channel identifier (network handle)
 *  \param[out]  ComMode                 Valid pointer to the communication mode which shall be requested
 *  \return      E_OK                    Request is accepted
 *  \pre         -
 *  \context     ANY
 *  \reentrant   TRUE
 ...
 * Protects the synchronization of PNC requests received via ERA from becoming inconsistent while being accessed on multiple partitions.
 * \protects ComM_ForwardUserReqSyncCounter, ComM_ForwardingUserReqMode
 * \usedin ComM_MainFunction, ComM_PncProcessRxSignalEra
 * \exclude -
 * \length LONG This exclusive area covers calls to several sub-functions.
 * \endexclusivearea
 */
 ...
 * \protects ComM_DcmRequestActive, ComM_DcmRequestActiveSyncCounter, ComM_StateChange, ComM_StateChangeSyncCounter
 * \usedin ComM_MainFunction, ComM_DCM_ActiveDiagnostic, ComM_DCM_InactiveDiagnostic, ComM_BusSM_ModeIndication
 * \exclude -
 ...
 * \usedin ComM_MainFunction, ComM_PncProcessRxSignalEra, ComM_PncProcessSignalRxEira, ComM_Nm_StateChangeNotifiaction,
...
/*!
 * \exclusivearea COMM_EXCLUSIVE_AREA_6
 * Protects the synchronization of extern PNC requests from becoming inconsistent while being accessed on multiple partitions.
 * \protects ComM_BusPncComModeReq, ComM_BusPncComModeReqSyncCounter
 * \usedin ComM_MainFunction, ComM_PncProcessRxSignalEira, ComM_Nm_NetworkStartIndication, ComM_Nm_RestartIndication,
...
/*!
 * \exclusivearea COMM_EXCLUSIVE_AREA_7
