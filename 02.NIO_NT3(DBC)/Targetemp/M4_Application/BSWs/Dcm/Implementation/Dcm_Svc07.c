...
/**        \file  Dcm_Svc07.c
 *         \unit  Svc07
 *        \brief  Contains the implementation of Svc07 unit.
 *
  ...
  )
{
  ...
  Dcm_ObdDtcManagerContextPtrType pRepContext = &pContext->Repeater.Context.Svc07.ReadDtcContext;
  ...
  )
{
  ...
  return Dcm_ObdDtcMgrCpyDemGetNxtFltrdDtc(pDataContext, ErrorCode, &pContext->Repeater.Context.Svc07.ReadDtcContext);                               /* SBSW_DCM_COMB_PTR_FORWARD */
}
# endif
# define DCM_STOP_SEC_CODE
# include "Dcm_MemMap.h"                                                                                                                             /* PRQA S 5087 */ /* MD_MSR_MemMap */
